...
#     start = timeit.timeit()
    ...
    for i in range(len(s_out),no_clocks):
        ...
        S_out[i] = mod((S_out[i-30]+S_out[i-23]+S_out[i-2]+S_out[i-1]),2)
    ...
    for i in range(len(s_out),no_clocks):
        System[i] = (S_out[i-(state_size-4)]*S_out[i-(state_size-1)]*S_out[i-(state_size-9 )]+ S_out[i-(state_size-4)]*S_out[i-(state_size-9)]*B[i-(state_size-12 )]+ S_out[i-(state_size-4 )]+ S_out[i-(state_size-1)]*S_out[i-(state_size-13)]*S_out[i-(state_size-9 )]+ S_out[i-(state_size-1)]*S_out[i-(state_size-9)]*B_out[i-(state_size-12 )]+ S_out[i-(state_size-1 )]+ S_out[i-(state_size-13)]*S_out[i-(state_size-9)]*B_out[i-(state_size-12 )]+ S_out[i-(state_size-13)]*S_out[i-(state_size-9 )]+ S_out[i-(state_size-13)]*B_out[i-(state_size-12 )]+ S_out[i-(state_size-13 )]+ B_out[i-(state_size-12)]) + O[i-state_size]
#         print(System[i])
    ...
    for j in range(len(System)-60):
        for i in range(30+j,60+j):
